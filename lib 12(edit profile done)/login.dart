...
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:sign_language_tool/homePage.dart'; // Adjust the import based on your project structure
  ...
  Future<void> _login() async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => BottomNavBar(userId: userId,)), // Replace with your BottomNavBar widget
      );
